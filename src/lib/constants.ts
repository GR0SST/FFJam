...
export const SYSTEM_CODEC_CONFIG = {
  [SupportedOS.Darwin]: { encoder: 'hevc_videotoolbox', options: [], multilier: 1.4, executable: "https://github.com/GR0SST/FFJam/raw/dev/bin/ffj" },
  [SupportedOS.Win32]: { encoder: 'hevc_nvenc', options: ['-vf format=yuv420p'], multilier: 1, executable: "https://github.com/GR0SST/FFJam/raw/dev/bin/ffj.exe" },
} as const;
